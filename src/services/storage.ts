...
export const DEFAULT_USERS: User[] = [
  {
    ...
    passwordHash: '010492',
    lastLogin: '2026-09-18 08:00:00',
    createdAt: '2025-01-01 00:00:00',
  },
  {
    id: 'USR-SEC-03',
    username: 'huynhvanphuc',
    fullName: 'Huỳnh Văn Phúc',
    role: 'OFFICER',
    shift: 'DAY',
    badgeNumber: 'SEC-03',
    phone: '',
    email: 'sec03.security@gmail.com',
    status: 'ACTIVE',
    failedLoginAttempts: 0,
    passwordHash: '030303',
  ...
  {
    id: 'USR-SEC-04',
    username: 'phamminhthanh',
    fullName: 'Phạm Minh Thanh',
    role: 'OFFICER',
    shift: 'DAY',
    badgeNumber: 'SEC-04',
    phone: '',
    email: 'sec04.security@gmail.com',
    status: 'ACTIVE',
    failedLoginAttempts: 0,
    passwordHash: '040404',
    createdAt: '2026-09-23 00:00:00',
  ...
  {
    id: 'USR-SEC-05',
    username: 'phamduylinh',
    fullName: 'Phạm Duy Linh',
    role: 'OFFICER',
    shift: 'DAY',
    badgeNumber: 'SEC-05',
    phone: '',
    email: 'sec05.security@gmail.com',
    status: 'ACTIVE',
    failedLoginAttempts: 0,
    passwordHash: '050505',
    createdAt: '2026-09-23 00:00:00',
  },
  {
    ...
    badgeNumber: 'SEC-06',
    phone: '',
    email: 'sec06.security@gmail.com',
    status: 'ACTIVE',
    failedLoginAttempts: 0,
    passwordHash: '060606',
    createdAt: '2026-09-23 00:00:00',
  ...
  {
    id: 'USR-SEC-07',
    username: 'tranhoangdung',
    fullName: 'Tranh Hoàng Dũng',
    role: 'OFFICER',
    shift: 'DAY',
    badgeNumber: 'SEC-07',
    phone: '',
    email: 'sec07.security@gmail.com',
    status: 'ACTIVE',
    failedLoginAttempts: 0,
    passwordHash: '070707',
    createdAt: '2026-09-23 00:00:00',
...
export class StorageService {
  ...
  static init() {
    ...
    if (!localStorage.getItem(STORAGE_KEYS.USERS)) {
      ...
      // Ensure Security Manager Trần Văn Sơn is always present in stored users
      try {
        const storedUsersRaw = localStorage.getItem(STORAGE_KEYS.USERS);
        if (storedUsersRaw) {
          const uList: User[] = JSON.parse(storedUsersRaw);
          const sonIdx = uList.findIndex(
            (u) =>
              u.email?.toLowerCase().includes('tranvanson') ||
        ...
        console.warn('Error syncing Security Manager Trần Văn Sơn', err);
      }
    }
  ...
  static authenticate(
    ...
    if (isTriple) {
      ...
      let cleanGmail = inputGmail.toLowerCase();
      if (cleanGmail.endsWith('@gmai.com')) {
        cleanGmail = cleanGmail.replace('@gmai.com', '@gmail.com');
      }

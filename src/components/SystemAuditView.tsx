...
export const SystemAuditView: React.FC<SystemAuditViewProps> = ({
  ...
  const handleExportExcel = () => {
    StorageService.recordAudit(
      ...
      `Mở hộp thoại xuất file Excel gồm ${logs.length} bản ghi Audit Log`
    );

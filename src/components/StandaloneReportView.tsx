        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          {downloadUrl ? (
            <a
              ...
              className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-bold text-xs rounded-xl flex items-center gap-1.5 shadow-md transition cursor-pointer animate-pulse"
            >
